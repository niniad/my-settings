...
description: Structured workflow for co-authoring docs. Use when user wants to write documentation, proposals, technical specs, or decision docs. Triggers: writing docs, creating proposals, drafting specs.
---
